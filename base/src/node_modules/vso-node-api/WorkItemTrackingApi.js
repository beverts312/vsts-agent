...
var WorkItemTrackingApi = (function (_super) {
    ...
    WorkItemTrackingApi.prototype.queryByWiql = function (wiql, project, onResult) {
        var _this = this;
        var routeValues = {
            project: project
        };
    ...
    WorkItemTrackingApi.prototype.queryById = function (id, project, onResult) {
        var _this = this;
        var routeValues = {
            project: project,
            id: id
    ...
    WorkItemTrackingApi.prototype.getReportingLinks = function (project, types, watermark, onResult) {
        var _this = this;
        var routeValues = {
            project: project
        };
    ...
    WorkItemTrackingApi.prototype.readReportingRevisionsGet = function (project, fields, types, watermark, includeIdentityRef, onResult) {
        var _this = this;
        var routeValues = {
            project: project
        };
    ...
    WorkItemTrackingApi.prototype.readReportingRevisionsPost = function (filter, project, watermark, onResult) {
        var _this = this;
        var routeValues = {
            project: project
        };
...
var QWorkItemTrackingApi = (function (_super) {
    ...
    QWorkItemTrackingApi.prototype.getRootNodes = function (project, depth) {
        var deferred = Q.defer();
        this.api.getRootNodes(project, depth, function (err, statusCode, classificationNode) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    QWorkItemTrackingApi.prototype.getFields = function () {
        var deferred = Q.defer();
        this.api.getFields(function (err, statusCode, field) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    QWorkItemTrackingApi.prototype.getQueries = function (project, expand, depth, includeDeleted) {
        var deferred = Q.defer();
        this.api.getQueries(project, expand, depth, includeDeleted, function (err, statusCode, querie) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    QWorkItemTrackingApi.prototype.getRevisions = function (id, top, skip, expand) {
        var deferred = Q.defer();
        this.api.getRevisions(id, top, skip, expand, function (err, statusCode, revision) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    QWorkItemTrackingApi.prototype.getUpdates = function (id, top, skip) {
        var deferred = Q.defer();
        this.api.getUpdates(id, top, skip, function (err, statusCode, update) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    QWorkItemTrackingApi.prototype.queryByWiql = function (wiql, project) {
        var deferred = Q.defer();
        this.api.queryByWiql(wiql, project, function (err, statusCode, wiql) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    QWorkItemTrackingApi.prototype.queryById = function (id, project) {
        var deferred = Q.defer();
        this.api.queryById(id, project, function (err, statusCode, wiql) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    QWorkItemTrackingApi.prototype.getReportingLinks = function (project, types, watermark) {
        var deferred = Q.defer();
        this.api.getReportingLinks(project, types, watermark, function (err, statusCode, workItemLink) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    QWorkItemTrackingApi.prototype.getRelationTypes = function () {
        var deferred = Q.defer();
        this.api.getRelationTypes(function (err, statusCode, workItemRelationType) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    QWorkItemTrackingApi.prototype.readReportingRevisionsGet = function (project, fields, types, watermark, includeIdentityRef) {
        var deferred = Q.defer();
        this.api.readReportingRevisionsGet(project, fields, types, watermark, includeIdentityRef, function (err, statusCode, workItemRevision) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    QWorkItemTrackingApi.prototype.readReportingRevisionsPost = function (filter, project, watermark) {
        var deferred = Q.defer();
        this.api.readReportingRevisionsPost(filter, project, watermark, function (err, statusCode, workItemRevision) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    QWorkItemTrackingApi.prototype.getWorkItems = function (ids, fields, asOf, expand) {
        var deferred = Q.defer();
        this.api.getWorkItems(ids, fields, asOf, expand, function (err, statusCode, workItem) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    QWorkItemTrackingApi.prototype.getWorkItemTypeCategories = function (project) {
        var deferred = Q.defer();
        this.api.getWorkItemTypeCategories(project, function (err, statusCode, workItemTypeCategorie) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    QWorkItemTrackingApi.prototype.getWorkItemTypes = function (project) {
        var deferred = Q.defer();
        this.api.getWorkItemTypes(project, function (err, statusCode, workItemType) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
