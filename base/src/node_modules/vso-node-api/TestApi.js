...
var TestApi = (function (_super) {
    ...
    TestApi.prototype.queryReportForBuild = function (build, project, sourceWorkflow, includeFailureDetails, buildToCompare, onResult) {
        var _this = this;
        var routeValues = {
            project: project
        };
    ...
    TestApi.prototype.queryReportForTestRun = function (project, testRunId, includeFailureDetails, onResult) {
        var _this = this;
        var routeValues = {
            project: project
        };
...
var QTestApi = (function (_super) {
    ...
    QTestApi.prototype.queryReportForBuild = function (build, project, sourceWorkflow, includeFailureDetails, buildToCompare) {
        var deferred = Q.defer();
        this.api.queryReportForBuild(build, project, sourceWorkflow, includeFailureDetails, buildToCompare, function (err, statusCode, ReportForBuild) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    QTestApi.prototype.queryReportForTestRun = function (project, testRunId, includeFailureDetails) {
        var deferred = Q.defer();
        this.api.queryReportForTestRun(project, testRunId, includeFailureDetails, function (err, statusCode, ReportForBuild) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
