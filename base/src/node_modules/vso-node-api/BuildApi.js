...
var BuildApi = (function (_super) {
    ...
    BuildApi.prototype.getDefinitions = function (project, name, type, onResult) {
        var _this = this;
        var routeValues = {
            project: project
        };
    ...
    BuildApi.prototype.getBuildOptionDefinitions = function (onResult) {
        var _this = this;
        var routeValues = {};
...
var QBuildApi = (function (_super) {
    ...
    QBuildApi.prototype.getDefinitions = function (project, name, type) {
        var deferred = Q.defer();
        this.api.getDefinitions(project, name, type, function (err, statusCode, definitions) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    QBuildApi.prototype.getBuildOptionDefinitions = function () {
        var deferred = Q.defer();
        this.api.getBuildOptionDefinitions(function (err, statusCode, options) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
