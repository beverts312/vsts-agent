...
var TaskAgentApiBase = (function (_super) {
    ...
    TaskAgentApiBase.prototype.getAgent = function (poolId, agentId, includeCapabilities, propertyFilters, onResult) {
        var _this = this;
        var routeValues = {
            poolId: poolId,
            agentId: agentId
    ...
    TaskAgentApiBase.prototype.getAgents = function (poolId, agentName, includeCapabilities, propertyFilters, demands, onResult) {
        var _this = this;
        var routeValues = {
            poolId: poolId
        };
    ...
    TaskAgentApiBase.prototype.getServiceEndpoints = function (scopeIdentifier, type, authSchemes, onResult) {
        var _this = this;
        var routeValues = {
            scopeIdentifier: scopeIdentifier
        };
...
var QTaskAgentApiBase = (function (_super) {
    ...
    QTaskAgentApiBase.prototype.getAgent = function (poolId, agentId, includeCapabilities, propertyFilters) {
        var deferred = Q.defer();
        this.api.getAgent(poolId, agentId, includeCapabilities, propertyFilters, function (err, statusCode, agent) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    QTaskAgentApiBase.prototype.getAgents = function (poolId, agentName, includeCapabilities, propertyFilters, demands) {
        var deferred = Q.defer();
        this.api.getAgents(poolId, agentName, includeCapabilities, propertyFilters, demands, function (err, statusCode, agents) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    QTaskAgentApiBase.prototype.getServiceEndpoints = function (scopeIdentifier, type, authSchemes) {
        var deferred = Q.defer();
        this.api.getServiceEndpoints(scopeIdentifier, type, authSchemes, function (err, statusCode, serviceendpoints) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
