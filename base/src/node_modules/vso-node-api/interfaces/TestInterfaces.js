...
exports.TypeInfo.AggregatedTestResults.fields = {
    resultsByOutcome: {
        isArray: true,
...
exports.TypeInfo.TestFailures.fields = {
    existingFailures: {
...
exports.TypeInfo.TestReport.fields = {
    aggregatedResults: {
        typeInfo: exports.TypeInfo.AggregatedTestResults
    },
    build: {
        typeInfo: exports.TypeInfo.BuildReference
    },
    ...
    testFailures: {
        typeInfo: exports.TypeInfo.TestFailures
    }
};
