...
var Q = require('q');
var JUnitResultReader = (function () {
    function JUnitResultReader() {
    }
    JUnitResultReader.prototype.readResults = function (file, runContext) {
        return new ResultReader("junit").readResults(file, runContext);
    };
    return JUnitResultReader;
})();
exports.JUnitResultReader = JUnitResultReader;
//-----------------------------------------------------
// Read NUnit results from a file
// - file: string () - location of the NUnit results file 
//-----------------------------------------------------
var NUnitResultReader = (function () {
    function NUnitResultReader() {
    }
    NUnitResultReader.prototype.readResults = function (file, runContext) {
        return new ResultReader("nunit").readResults(file, runContext);
    };
    return NUnitResultReader;
})();
exports.NUnitResultReader = NUnitResultReader;
var XUnitResultReader = (function () {
    function XUnitResultReader() {
    }
    XUnitResultReader.prototype.readResults = function (file, runContext) {
        return new ResultReader("xunit").readResults(file, runContext);
    };
    return XUnitResultReader;
})();
exports.XUnitResultReader = XUnitResultReader;
var TestSuiteSummary = (function () {
    ...
    TestSuiteSummary.prototype.addResults = function (res) {
        this.results = this.results.concat(res);
    };
    return TestSuiteSummary;
})();
exports.TestSuiteSummary = TestSuiteSummary;
var ResultReader = (function () {
    function ResultReader(readerType) {
        this.type = readerType;
    }
    ResultReader.prototype.readResults = function (file, runContext) {
        var defer = Q.defer();
        var _this = this;
    ...
    ResultReader.prototype.readTestRunData = function (contents, runContext) {
        var defer = Q.defer();
        var testRun2;
        var _this = this;
    ...
    ResultReader.prototype.parseXml = function (res, runContext) {
        if (this.type == "junit") {
    ...
    ResultReader.prototype.parseJUnitXml = function (res, runContext) {
        var testRun2;
    ...
    ResultReader.prototype.readTestSuiteJUnitXml = function (rootNode, buildRequestedFor) {
        ...
        for (var i = 0; i < rootNode.testcase.count(); i++) {
            ...
            var testResult = {
                ...
                durationInMs: "" + Math.round(testCaseDuration * 1000),
    ...
    ResultReader.prototype.parseNUnitXml = function (res, runContext) {
        var testRun2;
        var buildId = runContext.buildId;
        var buildRequestedFor = runContext.requestedFor;
    ...
    ResultReader.prototype.FindNUnitTestCaseNodes = function (startNode, hostName, buildRequestedFor, assemblyName) {
    ...
    ResultReader.prototype.parseXUnitXml = function (res, runContext) {
        var testRun2;
    ...
    ResultReader.prototype.FindXUnitTestCaseNodes = function (startNode, hostName, buildRequestedFor, assemblyName) {
        var foundTestResults = [];
        var testStorage = assemblyName;
...
exports.ResultReader = ResultReader;
