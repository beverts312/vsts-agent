...
var Q = require('q');
var readline = require("readline"), read = require('read'), async = require('async'), argparser = require('minimist');
...
// Q wrapper
function Qget(inputs) {
    var defer = Q.defer();
    this.get(inputs, function (err, result) {
        if (err) {
            defer.reject(err);
            return;
        }
