...
var FileContainerApi = (function (_super) {
    ...
    FileContainerApi.prototype.getItems = function (containerId, scope, itemPath, metadata, format, downloadFileName, includeDownloadTickets, onResult) {
        var _this = this;
        var routeValues = {
            containerId: containerId
        };
...
var QFileContainerApi = (function (_super) {
    ...
    QFileContainerApi.prototype.getItems = function (containerId, scope, itemPath, metadata, format, downloadFileName, includeDownloadTickets) {
        var deferred = Q.defer();
        this.api.getItems(containerId, scope, itemPath, metadata, format, downloadFileName, includeDownloadTickets, function (err, statusCode, Containers) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
