...
var GitApi = (function (_super) {
    ...
    GitApi.prototype.createCommit = function (repositoryId, project, onResult) {
        var _this = this;
        var routeValues = {
            project: project,
            repositoryId: repositoryId
    ...
    GitApi.prototype.getPullRequest = function (repositoryId, pullRequestId, project, maxCommentLength, skip, top, onResult) {
        var _this = this;
        var routeValues = {
            project: project,
            repositoryId: repositoryId,
...
var QGitApi = (function (_super) {
    ...
    QGitApi.prototype.createCommit = function (repositoryId, project) {
        var deferred = Q.defer();
        this.api.createCommit(repositoryId, project, function (err, statusCode, Commit) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    QGitApi.prototype.getPullRequest = function (repositoryId, pullRequestId, project, maxCommentLength, skip, top) {
        var deferred = Q.defer();
        this.api.getPullRequest(repositoryId, pullRequestId, project, maxCommentLength, skip, top, function (err, statusCode, PullRequest) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
