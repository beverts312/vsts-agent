...
var path = require('path'), fs = require('fs'), si = require('svcinstall'), argparser = require('minimist'), url = require('url'), heartbeat = require('./heartbeat'), shelljs = require('shelljs');
...
var installSvc = function (svcName, options) {
    var defer = Q.defer();
