...
var TaskApi = (function (_super) {
    ...
    TaskApi.prototype.postEvent = function (eventData, scopeIdentifier, hubName, planId, onResult) {
        var _this = this;
        var routeValues = {
            scopeIdentifier: scopeIdentifier,
            hubName: hubName,
        ...
        this.vsoClient.getVersioningData("3.0-preview.1", "distributedtask", "557624af-b29e-4c20-8ab0-0399d2204f3f", routeValues)
            ...
            _this.restClient.create(url, apiVersion, eventData, null, serializationData, onResult);
        })
            .fail(function (error) {
            onResult(error, error.statusCode);
        });
    };
    TaskApi.prototype.postLines = function (lines, scopeIdentifier, hubName, planId, timelineId, recordId, onResult) {
        var _this = this;
        var routeValues = {
            scopeIdentifier: scopeIdentifier,
            hubName: hubName,
    ...
    TaskApi.prototype.appendLog = function (customHeaders, contentStream, scopeIdentifier, hubName, planId, logId, onResult) {
        var _this = this;
        var routeValues = {
            scopeIdentifier: scopeIdentifier,
            hubName: hubName,
...
var QTaskApi = (function (_super) {
    ...
    QTaskApi.prototype.appendLog = function (customHeaders, contentStream, scopeIdentifier, hubName, planId, logId) {
        var deferred = Q.defer();
        this.api.appendLog(customHeaders, contentStream, scopeIdentifier, hubName, planId, logId, function (err, statusCode, log) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
